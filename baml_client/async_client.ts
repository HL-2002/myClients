...
import {CarPolicy, HealthPolicy, Resume} from "./types"
...
export class BamlAsyncClient {
  ...
  async ExtractHealthPolicy(
    ...
    try {
      ...
      return raw.parsed() as HealthPolicy
    } catch (error: any) {
...
class BamlStreamClient {
  ...
  ExtractHealthPolicy(
      policy: Image,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): BamlStream<RecursivePartialNull<HealthPolicy>, HealthPolicy> {
    try {
      ...
      return new BamlStream<RecursivePartialNull<HealthPolicy>, HealthPolicy>(
        raw,
        (a): a is RecursivePartialNull<HealthPolicy> => a,
        (a): a is HealthPolicy => a,
        this.ctx_manager.cloneContext(),
        __baml_options__?.tb?.__tb(),
      )
    } catch (error) {
